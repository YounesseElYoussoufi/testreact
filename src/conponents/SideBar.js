...
import DashboardComponent from './DashboardComponemnt';

import UserManagement from './UserComponents';
...
const menuItems = [
  { id: 'home', text: 'Home', icon: <HomeIcon />, component: Home },
  { id: 'dashboard', text: 'Dashboard', icon: <DashboardIcon />, component: DashboardComponent },

  { id: 'about', text: 'users', icon: <PersonIcon />, component: UserManagement },
];
...
const DrawerComponent = ({ user }) => {
  ...
  const SelectedComponent = menuItems.find(item => item.id === selectedComponent)?.component || Home;
